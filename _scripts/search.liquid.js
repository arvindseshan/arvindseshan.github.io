          ...
          {%- unless child.title == 'divider' -%}
            {
              ...
              {%- if child.permalink contains "/projects/" -%}{%- assign url = "/projects/" -%} {%- else -%}{%- assign url = child.url -%}{%- endif -%}
      ...
      {%- else -%}
        {
          ...
          {%- if p.permalink contains "/projects/" -%}{%- assign url = "/projects/" -%} {%- else -%}{%- assign url = p.url -%}{%- endif -%}
